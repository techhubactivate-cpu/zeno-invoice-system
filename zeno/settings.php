...
$default_currency = $_SESSION['default_currency'] ?? 'USD';

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_profile'])) {
        $currency = $_POST['default_currency'] ?? 'USD';
        $_SESSION['default_currency'] = $currency;
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .settings-card-header h2 { font-size: 18px; font-weight: 600; color: var(--gray-800); }
        .settings-card-header h2 i { margin-right: 8px; color: var(--primary); }
        ...
        .btn-primary {
            ...
            color: white; padding: 12px 24px; border: none; border-radius: 10px; font-weight: 600; cursor: pointer;
        }
            ...
            <div class="settings-grid">
                <div class="settings-card">
                    <div class="settings-card-header">
                        <h2><i class="fas fa-globe"></i> Preferences</h2>
                    </div>
                        ...
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <select name="default_currency">
                                    <option value="USD" <?php echo $default_currency == 'USD' ? 'selected' : ''; ?>>USD - US Dollar ($)</option>
                                    <option value="EUR" <?php echo $default_currency == 'EUR' ? 'selected' : ''; ?>>EUR - Euro (€)</option>
                                    <option value="GBP" <?php echo $default_currency == 'GBP' ? 'selected' : ''; ?>>GBP - British Pound (£)</option>
                                    <option value="KES" <?php echo $default_currency == 'KES' ? 'selected' : ''; ?>>KES - Kenyan Shilling (KSh)</option>
                                </select>
                            </div>
                            <button type="submit" name="update_profile" class="btn-primary"><i class="fas fa-save"></i> Save Preferences</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="settings-card">
                    ...
                    <div class="settings-card-body">
                        <form method="POST">
                            ...
                            <button type="submit" name="update_password" class="btn-primary"><i class="fas fa-key"></i> Update Password</button>
                        </form>
                    </div>
                </div>
            </div>
